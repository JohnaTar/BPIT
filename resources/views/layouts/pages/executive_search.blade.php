...
<div class="container">
                  ...
                  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="images/service/slide/s1.png" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="images/service/slide/s2.png" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="images/service/slide/s3.png" alt="">
                        </div>
                          <div class="item">
        ...
        <div class="row">
            <div class="col-md-7 spanish">
                ...
                <p>
                    <i class="fa fa-check-square-o" aria-hidden="true"></i> : <strong>คัดเลือกคนแบบเฉพาะเจาะจง </strong>ทั้งทักษะในงาน-คุณสมบัติ-ความเหมะสมกับองค์กร<br>
                    <i class="fa fa-check-square-o" aria-hidden="true"></i> : <strong>ที่ผ่านมาผู้สมัครของเรามีอัตราผ่านการคักเลือกจากลูกค้าในอัตราที่สูง</strong> 
                    <br>
                     <i class="fa fa-check-square-o" aria-hidden="true"></i> : <strong> 
                        หาผู้สมัครได้อย่างรวดเร็ว </strong>(ภายใน 1-2 สัปดาห์เท่านั้นท่านจะได้ผู้สมัครที่มีคุณสมบัติตรงตามต้องการ)
                    <br>
                    <i class="fa fa-check-square-o" aria-hidden="true"></i> : 
                        <strong><U> ค่าบริการที่ถูกกว่า</U> </strong>แต่คุณภาพมาตรฐานระดับเดียวกับบริษัท Recruit ข้ามชาติขนาดใหญ่
                      <br>
                   <i class="fa fa-check-square-o" aria-hidden="true"></i> : 
                       <strong><U>ไม่เก็บค่าบริการล่วงหน้า</U></strong>
                      <br>
                    <i class="fa fa-check-square-o" aria-hidden="true"></i> : 
                       <strong>เราช่วยคุณลดความยุ่งยากในการสรรหาคน</strong> 
                     <br>
                     <i class="fa fa-check-square-o" aria-hidden="true"></i> : 
                        <strong> เราเป็นแหล่งที่ดีในการสรรหาบุคลากรในตำแหน่งงานที่สำคัญๆ </strong>
            ...
            <div class="col-md-5">
                <a href="portfolio-item.html">
                    <img class="img-responsive img-hover" src="images/service/service2.png" alt="">
                </a>
            </div>
        </div>
        <!-- /.row -->
