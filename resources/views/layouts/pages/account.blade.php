...
@section('content')
 <div class="container">
        ...
        <div class="row spanish">
            <div class="col-lg-12">
                <h1 class="page-header">บริการจัดทำบัญชี
                 
                </h1>
                <ol class="breadcrumb">
                    <li><a href="{{url('home')}}">หน้าแรก</a>
                    </li>
                    <li class="active">บริการจัดทำบัญชี</li>
                </ol>
            </div>
        </div>
            <div class="row english">
            <div class="col-lg-12">
                <h1 class="page-header">Accounting Service
                 
                </h1>
                <ol class="breadcrumb">
                    <li><a href="{{url('home')}}">Home</a>
                    </li>
                    <li class="active">Accounting Service</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
         <div class="col-md-6">
                <img class="img-responsive" src="images/acc/acc2.png" alt="">
            </div>
            <div class="col-md-6 spanish">
              ...
              <p><i class="fa fa-check-square-o" style="color:green;" aria-hidden="true"></i> : ปิดบัญชี และจัดทำงบการเงิน (งบดุลและงบกำไรขาดทุน) พร้อมด้วยรายละเอียดประกอบงบ ได้แก่ งบทดลอง, รายละเอียดบัญชีลูกหนี้และเจ้าหนี้</p>
              
              <p><i class="fa fa-check-square-o" style="color:green;" aria-hidden="true"></i> : จัดทำและยื่นแบบภาษีประจำเดือน (ภงด. 1, ภงด. 3, ภงด. 53)</p>
               <p><i class="fa fa-check-square-o" style="color:green;" aria-hidden="true"></i> : จัดทำรายงานภาษีซื้อและรายงานภาษีขาย (ภพ.30)</p>
               <p><i class="fa fa-check-square-o" style="color:green;" aria-hidden="true"></i> : จัดทำพร้อมยื่นประมาณการรายได้ครึ่งปี ภงด. 51 และยื่นภาษีประจำปี ภงด. 50</p>
              ...
              <p><i class="fa fa-check-square-o" style="color:green;" aria-hidden="true"></i> : Account closing and financial statement preparation, including details such as trial balance, accounts receivable and accounts payable sub-ledger</p>
              
              <p><i class="fa fa-check-square-o" style="color:green;" aria-hidden="true"></i> : Monthly tax filing (Phor Ngor Dor 1, 3 and 53)</p>
               <p><i class="fa fa-check-square-o" style="color:green;" aria-hidden="true"></i> : Preparation of input tax and output tax report for VAT filing (Phor Por 30)</p>
               <p><i class="fa fa-check-square-o" style="color:green;" aria-hidden="true"></i> : Preparation of Corporate Income Tax Filing Half-year and Annually (Phor Ngor Dor 51 and 50)</p>
...
<hr>
   <div class="row">
                ...
                <p>
                    ...
                    <br>
                     <h3><i class="fa fa-mobile fa-2x " style="color:#5bc0de;" aria-hidden="true"></i> : รายละเอียดเพิ่มเติม</h3>
                        ...
                        <strong>คุณนงลักษณ์ ศรีศักดิ์พงษ์ – มือถือ (085) 166 – 6293 <br>สำนักงานโทร (02) 434 3195 – 7 <br>E-mail: nongluk_s@bpit.co.th 
                         </strong>
                ...
                <p>
                    ...
                    <br>
                     <h3><i class="fa fa-mobile fa-2x " style="color:#5bc0de;" aria-hidden="true"></i> : For more information, please contact</h3>
                        ...
                        <strong>Khun Nongluk <br>  Mobile Phone +66(85) 166 – 6293 <br>
                          Office +66(2) 434 3195 – 7 <br>E-mail: nongluk_s@bpit.co.th 
                         </strong>
            ...
            <div class="col-md-6">
                <img class="img-responsive" src="images/acc/acc1.png" alt="">
            </div>
        </div>
