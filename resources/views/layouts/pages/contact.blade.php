 ...
 <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <h3>สำนักงานใหญ่ </h3>
                <p>
                 95/601-602 ถนนบรมราชชนนี แขวงอรุณอมรินทร์ เขตบางกอกน้อย กรุงเทพฯ 10700 ประเทศไทย 
                 
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (02) 434-3195-7</p>
                 <p><i class="fa fa-fax"></i> 
                    <abbr title="Fax">F</abbr>: (02) 435-6469</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:nattida_k@bpit.co.th">nattida_k@bpit.co.th</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: วันจันทร์ - วันศุกร์: 8.30 - 17.30 น.</p>
    ...
    <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p>
                29/13 หมู่ 9, อาคารรัฐกิจ ชั้น 2 ถนนสุขุมวิท ตำบลหนองปรือ อำเภอบางละมุง (พัทยา) ชลบุรี 20260 ประเทศไทย
                

                
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (038) 416-975-7</p>
                 <p><i class="fa fa-fax"></i> 
                    <abbr title="Fax">F</abbr>: (038) 416-978 </p>
                <p><i class="fa fa-envelope-o"></i> 
        ...
        <ol class="breadcrumb">
          ...
          <div class="row">
            ...
            <!-- Contact Details Column -->
            <div class="col-md-4">
                <h3>สาขาชลบุรี(นิคมอมตะ)</h3>



                <p>
                700/219 หมู่ 1, ตำบลคลองตำหรุ อำเภอเมือง ชลบุรี 20000 ประเทศไทย 
                

                
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (038) 458-925-6</p>
                 <p><i class="fa fa-fax"></i> 
